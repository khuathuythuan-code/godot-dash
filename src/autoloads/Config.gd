...
@export var blur_lightness: float = 0.5
...
func _init():
	...
	blur_lightness = config_file.get_value("Graphics", "blur_lightness", blur_lightness)
...
func save() -> void:
	...
	config_file.set_value("Graphics", "blur_lightness", blur_lightness)
