...
func use_normal_sprite() -> CheckpointPlacementBuilder:
	...
	new_checkpoint.material = new_checkpoint.material.duplicate()
	new_checkpoint.material.set_shader_parameter(&"hue", 1.0 / 3.0)
	return self
...
func use_auto_sprite() -> CheckpointPlacementBuilder:
	new_checkpoint = CHECKPOINT_PREFAB.instantiate()
	new_checkpoint.material = new_checkpoint.material.duplicate()
	new_checkpoint.material.set_shader_parameter(&"hue", 0.107)
	return self
